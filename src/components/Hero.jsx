            ...
            {isLoading && (
                ...
                overflow-hidden rounded-lg bg-blue-75">
                    <div>
                        ...
                        z-50 cursor-pointer overflow-hidden rounded-lg">
                            <div onClick={handeleMiniVdClick} className="origin-center
                        ...
                        <video
                            ...
                            muted
                            id="next-video"
                            className="absolute-center invisible absolute
                        ...
                        <h1 className="absolute special-font hero-heading
                        ...
                        <div className="absolute left-0 top-0 z-40 size-full">
                            <div className="mt-24 px-5 sm:px-10">
                                ...
                                text-blue-75">redefi<b>n</b>e</h1>
                                <p className="mb-5 max-w-64 font-robert-regular
                                text-blue-75">Enter the Metagame Layer<br />
